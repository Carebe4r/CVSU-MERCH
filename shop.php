		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="product-single.php" class="img-prod"><img class="img-fluid" src="images/featured-1.png" alt="Colorlib Template">
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="product-single.php">BSIT Lanyard</a></h3>
							<div class="d-flex">
								<div class="pricing">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="product-single.php" class="img-prod"><img class="img-fluid" src="images/featured-2.png" alt="Colorlib Template">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid" src="images/featured-3.png" alt="Colorlib Template">
							<div class="overlay"></div>
						</a>
						<div class="text py-3 pb-4 px-3 text-center">
