...
<body class="goto-here">
        ...
        <div class="col-lg-12 d-block">
          <div class="row d-flex">
            <div class="col-md pr-4 d-flex topper align-items-center">
              ...
              <span class="text-left" style="color: white;">+8-7000</span>
            </div>
  ...
  <div class="hero-wrap hero-bread" style="background-image: url('images/about-header.png');">
    <div class="container">
...
<<<<<<< HEAD
            ...
            <p>Whether you're looking for t-shirts, hoodies, accessories, or other CVSU-themed items, we have a wide
              range of products to choose from.
              By purchasing from CVSU University Merch Website, you directly contribute to the development of the
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">CVSU Merch</h2>
