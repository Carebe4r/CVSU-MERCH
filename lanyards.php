			...
			<div class="row justify-content-center">
				<div class="col-md-10 mb-5 text-center">
					<ul class="product-category">
						<li><a href="shop.html" class="">All</a></li>
						<li><a href="lanyards.html" class="active">Lanyards</a></li>
						<li><a href="shirts.html" class="">Shirts</a></li>
					</ul>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid" src="images/featured-1.png" alt="Colorlib Template">
						</a>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="product-single.html" class="img-prod"><img class="img-fluid" src="images/featured-2.png" alt="Colorlib Template">
