...
<head>
	<title>Lanyards | Cavite State University - Bacoor</title>
	<meta charset="utf-8">
	...
	<div class="hero-wrap hero-bread" style="background-image: url('images/product-header-vivid.png');">
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				...
				<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span class="mr-2"><a href="index.php">Product</a></span> <span>Lanyards</span></p>
			...
			<div class="row justify-content-center">
				<div class="col-md-10 mb-5 text-center">
					<ul class="product-category">
						<li><a href="shop.php" class="">All</a></li>
						<li><a href="lanyards.php" class="active">Lanyards</a></li>
						<li><a href="shirts.php" class="">Shirts</a></li>
					</ul>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="bsit-lanyard.php" class="img-prod"><img class="img-fluid" src="images/featured-1.png"
								alt="BSIT Lanyard">
						</a>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						<a href="bshm-lanyard.php" class="img-prod"><img class="img-fluid"
								src="images/featured-2.png" alt="BSHM Lanyard">
