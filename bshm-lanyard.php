...
<head>
	<title>BSHM Lanyard | Cavite State University Bacoor</title>
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span class="mr-2"><a href="index.php">Product</a></span> <span>BSHM LANYARD</span></p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-1.jpg" class="image-popup"><img src="images/featured-2.png" class="img-fluid" alt="BSHM Lanyard"></a>
				</div>
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					<h3>BSHM LANYARD</h3>

					<p class="price"><span>₱75</span></p>
					<p> Show off your course as an H.M Student. Get this and be proud!
					</p>
					<div class="row mt-4">
						<div class="col-md-6">
